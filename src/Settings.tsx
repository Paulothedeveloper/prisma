...
const WHATS_NEW: string[] = [
  "TELA PRETA — causa-raiz encontrada e MORTA. Não era a GPU (zero resets de driver nos logs) nem o código: era o WebView2 sendo MORTO por fora. Um 'taskkill /IM msedgewebview2' (de outra ferramenta/app no PC) mata TODOS os WebView2 do sistema de uma vez — não só os de um app — deixando a janela preta. Agora o PRISMA tem um WATCHDOG: o app pinga a si mesmo a cada 2s e, se o render morrer (kill externo, crash ou perda de compositor), ele RECRIA a tela sozinho em segundos, sem você fazer nada. Você não perde a biblioteca (é re-lida do banco). Funciona mesmo se outro app derrubar os WebView2 do sistema.",
