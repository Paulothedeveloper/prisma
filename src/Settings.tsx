...
const WHATS_NEW: string[] = [
  "Correção: o app ficava com a TELA BRANCA depois de minimizado por muito tempo. Era o WebView2 (Chromium) descartando o renderizador quando achava a janela \"oculta\". Desligamos esse comportamento (CalculateNativeWinOcclusion + backgrounding de janela oculta) — agora volta normal do minimizado.",
